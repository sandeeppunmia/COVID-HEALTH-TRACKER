...
import {View,Text,Image,Icon,TextInput,TouchableOpacity,StyleSheet,Alert,ScrollView,SoundUrl} from 'react-native';
...
export default class HomeScreen extends Component{
  ...
  getUserDetails=async()=>{
    ...
    var requestRef = await db.collection('parameters').doc(this.state.emailId)
    .get()
    .then((doc)=>{
      this.setState({
        name:doc.data().name,
    ...
    if(date2 - date1 > 20){
      Alert.alert("Please check the parameters")
      this.playSound()
    }else{
      Alert.alert("Your parameters are up to date")
    }
  }

  updateUserDetails=()=>{
    db.collection('parameters').doc(this.state.emailId)
    .update({
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.ageRow}>
            ...
            <Image source={require("../assets/ageIcon.png")}
            resizeMode="contain"
            style={styles.image}/>
            <TextInput
          ...
          <View style={styles.temperatureRow}>
            ...
            <Image source={require("../assets/temperatureIcon.png")}
            resizeMode="contain"
            style={styles.image2}/>
            <TextInput
