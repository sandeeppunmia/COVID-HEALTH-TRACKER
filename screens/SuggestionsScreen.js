    ...
    render(){
        return(
            ...
            <View>
                 ...
                 <Text style={styles.content}>3. Exercise for a minimum 30 minutes every day</Text>
                 <Text style={styles.content}>4. Play a few memory games</Text>
                 <Text style={styles.content}>5. Check your oxygen level</Text>
                 <Text style={styles.content}>6. Watch out for other symptoms</Text>
                 <Text style={styles.content}></Text>
                 <Text style={styles.content}></Text>

                 <Text style={styles.heading}>
                    Food and nutrition tips during self quarantine - as planned below:
                 </Text>

                 <Text style={styles.content}>1. Take only what you need (Avoid Overeating)</Text>
                 <Text style={styles.content}>2. Be strategic about the use of ingredients - prioritize fresh products</Text>
                 <Text style={styles.content}>3. Intake only home-cooked meals (Try to avoid totally outdoor dining)</Text>
                 <Text style={styles.content}>4. Follow safe food handling practices </Text>
                 <Text style={styles.content}>5. Limit your salt, sugar and junk food intake</Text>
                 <Text style={styles.content}>6. Consume enough fibre </Text>
                 <Text style={styles.content}>7. Stay hydrated</Text>
                 <Text style={styles.content}>8. Avoid alcohol, gutka,smoking, etc</Text>
                 <Text style={styles.content}></Text>
                 <Text style={styles.content}></Text>

                 <Text style={styles.heading}>WEAKNESS POST COVID?</Text>
                 <Text style={styles.heading}>HERE'S WHAT TO DO </Text>
                 <Text style={styles.content}>1. Go easy on exercise. Start with slow walks, breathing exercise & meditation. Our body needs rest. No intense workout. </Text>
                 <Text style={styles.content}>2. Get 30 mins morning sunlight daily. </Text>
                 <Text style={styles.content}>3. Have 1 date, handful of raisins, 5 almonds, 2 walnuts in morning (all soaked overnight).</Text>
